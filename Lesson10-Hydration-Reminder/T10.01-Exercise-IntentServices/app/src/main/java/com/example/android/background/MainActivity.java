...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent increamentWaterCountIntent = new Intent(this, WaterReminderIntentService.class);
        increamentWaterCountIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
